        ...
        <div class="tp-banner rev_slider" data-version="5.0">
            <ul>
                ...
                <li data-transition="fade" data-slotamount="1" data-masterspeed="1000">
                    <img alt="" src="../../assets/base/img/content/backgrounds/bg-43.jpg" data-bgposition="center center" data-bgfit="cover"
                ...
                <!--BEGIN: SLIDE #2 -->
                <li data-transition="fade" data-slotamount="1" data-masterspeed="1000">
                    <img alt="" src="../../assets/base/img/content/backgrounds/bg-20.jpg" data-bgposition="center center" data-bgfit="cover"
                        data-bgrepeat="no-repeat">
                    <div class="tp-caption customin customout" data-x="center" data-y="center" data-hoffset="" data-voffset="-50" data-speed="500"
                        data-start="1000" data-transform_idle="o:1;" data-transform_in="rX:0.5;scaleX:0.75;scaleY:0.75;o:0;s:500;e:Back.easeInOut;"
                ...
                <li data-transition="fade" data-slotamount="1" data-masterspeed="700" data-delay="6000" data-thumb="">
                    ...
                    <img alt="" src="../../assets/base/img/content/backgrounds/bg-19.jpg" data-bgposition="center center" data-bgfit="cover"
                    ...
                    <div class="rs-background-video-layer" data-forcerewind="on" data-volume="mute" data-videowidth="100%" data-videoheight="100%"
                        data-videomp4="../../assets/base/media/video/video-2.mp4" data-videopreload="preload" data-videoloop="none"
                        data-forceCover="1" data-aspectratio="16:9" data-autoplay="true" data-autoplayonlyfirsttime="false" data-nextslideatend="true">
                    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <a href="{{url('alad/teamgym')}}">
                    <div class="c-content-feature-2" data-height="height" style="height: 250px;">
                        ...
                        <p>
                            TeamGym это сочетание акробатических прыжков, прыжков на мини трамплине и вольных упражнений. Динамический, командный вид
                            спорта, подходящий и мальчикам и девочкам
                        </p>
                    </div>
                </a>
            </div>
            <div class="col-md-6">
                <a href="{{url('alad/trampoliinvoimlemine')}}">
                    <div class="c-content-feature-2" data-height="height" style="height: 250px;">
                        ...
                        <p>
                            Выполнение высоких и непрерывных прыжков с разнообразием элементов с вращением вперёд и назад с пируэтами и без них. Упражнение
                            выполняется с хорошей координацией, позами тела, хорошей техникой и с сохранением высоты прыжков.
                        </p>
                    </div>
                </a>
            </div>
            <div class="col-md-6">
                <a href="{{url('alad/mudilased')}}">
                    <div class="c-content-feature-2" data-height="height" style="height: 250px;">
                        ...
                        <p>Lõbus ja üldarendav trenn väikestele (2 - 4 aastat). Õpitakse väga lihtsaid, juurdeviivaid harjutusi
                            akrobaatika algõppeks, tehakse vanusele sobivaid koordinatsiooni- ja rütmiharjutusi</p>
                    </div>
                </a>
            </div>
            <div class="col-md-6">
                <a href="{{url('alad/   show-ruhm')}}">
                    <div class="c-content-feature-2" data-height="height" style="height: 250px;">
                        ...
                        <p>Ootame trenni poisse ja tüdrukuid, kellele meeldib esineda ning kes tahab osa võtta ainulaadsest
                            show programmist. Meie programmid ühendavad endas tantsu ja akrobaatilisi elemente.</p>
                    </div>
                </a>
            </div>
