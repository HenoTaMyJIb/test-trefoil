            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="panel">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <i class="voyager-calendar"></i> {{ __('voyager.post.created_at') }}
                                </h3>
                                <div class="panel-actions">
                                    <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                                </div>
                            ...
                            <div class="panel-body">
                                <input type="date" class="form-control" id="created_at" name="created_at" value="@if(isset($dataTypeContent->created_at)){{ $dataTypeContent->created_at->format('Y-m-d') }}@else{{\Carbon\Carbon::today()->format('Y-m-d')}}@endif">
                            </div>
                        </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            @php
                                ...
                                $exclude = ['title', 'body', 'excerpt', 'slug', 'status', 'category_id', 'author_id', 'featured', 'image', 'meta_description', 'meta_keywords', 'seo_title', 'created_at'];
                            @endphp
